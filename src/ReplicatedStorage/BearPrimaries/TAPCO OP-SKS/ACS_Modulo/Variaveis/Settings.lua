...
---------------------=[ GERAL ]=--------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	Name = "Simonov Semi-Automatic Carbine OP-SKS Tapco Modernized"
	,BulletType = "7.62x39mm SAP-T"
	,Ammo = Var.Ammo.Value
	,ChangeFOV = {50, 30}
	,ZoomAnim = true
	,FocusOnSight = false
...
----------------------------------------------------------------------------------------------------
	...
	,HPunchBase = 1.3				--- Horizontal Punch
	...
	,TorsoDamage = {54,73}
	,HeadDamage = {85,110}
	,BulletPenetration = 76			 ---- Between 0 & 100%
	,FallOfDamage = .9
	----------------------------------------------------------------------------------------------------
	-------------------=[ PROJETIL ]=-------------------------------------------------------------------
	----------------------------------------------------------------------------------------------------
