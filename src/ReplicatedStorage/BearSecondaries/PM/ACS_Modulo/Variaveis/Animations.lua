...
--//Client Animations
	...
	InspectAnim = function(char, speed, objs)
		...
		ts(objs[3],TweenInfo.new(1),{C1 = CFrame.new(1.565,-0.468,-1.812) * CFrame.Angles(math.rad(-138.766),math.rad(19.846),math.rad(-11.113))}):Play()
		ts(objs[2],TweenInfo.new(1),{C1 = CFrame.new(-1.275,0.343,-0.679) * CFrame.Angles(math.rad(-102.000),math.rad(-22.000),math.rad(22.000))}):Play()
		wait(5)
