...
local event = game.ReplicatedStorage.ACS_Engine.Eventos.MedSys.PainKiller
local value = 1
local module = {
...
--//Client Animations
	...
	ChamberAnim = function(char, speed, objs)
		...
		wait(0.3)
		ts(objs[2],TweenInfo.new(0.25,Enum.EasingStyle.Back,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.507,0.843,-1.410) * CFrame.Angles(math.rad(-94.323),math.rad(-11.776),math.rad(-11.240))}):Play()
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Back,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.296,0.988,-1.020) * CFrame.Angles(math.rad(-100.501),math.rad(3.210),math.rad(63.136))}):Play()
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Open"):Play()
		wait(0.7)
			ts(objs[2],TweenInfo.new(0.6,Enum.EasingStyle.Elastic,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.925,0.672,-0.532) * CFrame.Angles(math.rad(-118.939),math.rad(20.208),math.rad(-105.370))}):Play()
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{C1 = CFrame.new(1.786,0.988,0.329) * CFrame.Angles(math.rad(-91.593),math.rad(7.945),math.rad(-70.645))}):Play()

			
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Use"):Play()
			wait(1)
			ts(objs[2],TweenInfo.new(0.5),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.1, 0, 0) * CFrame.Angles(math.rad(-15), math.rad(0), math.rad(-20))}):Play()
			ts(objs[3],TweenInfo.new(.75),{C1 = CFrame.new(0,-0.65,-2) * CFrame.Angles(math.rad(-75),math.rad(55),math.rad(30))}):Play()
			
			wait(1.5)
			ts(objs[2],TweenInfo.new(0.5,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.1, 0, 0) * CFrame.Angles(math.rad(-15), math.rad(0), math.rad(-20))}):Play()
			ts(objs[3],TweenInfo.new(0.45,Enum.EasingStyle.Back,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.027,-0.903,-0.523) * CFrame.Angles(math.rad(-113.438),math.rad(69.113),math.rad(13.456))}):Play()
			event:FireServer()
			value = value - 1
			wait(0.3)
			ts(objs[2],TweenInfo.new(0.5,Enum.EasingStyle.Back,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.507,0.843,-1.410) * CFrame.Angles(math.rad(-94.323),math.rad(-11.776),math.rad(-11.240))}):Play()
			ts(objs[3],TweenInfo.new(0.4,Enum.EasingStyle.Back,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.296,0.988,-1.020) * CFrame.Angles(math.rad(-100.501),math.rad(3.210),math.rad(63.136))}):Play()
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Close"):Play()
			wait(1)
		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quart),{C1 = require(script.Parent.Settings).RightPos}):Play()
		ts(objs[3],TweenInfo.new(0.4,Enum.EasingStyle.Quart),{C1 = require(script.Parent.Settings).LeftPos}):Play()
			wait(0.3)
			if value <= 0 then
