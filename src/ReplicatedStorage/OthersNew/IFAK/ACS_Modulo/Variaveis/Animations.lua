...
local event = game.ReplicatedStorage.ACS_Engine.Eventos.MedSys.Energetic
local event2 = game.ReplicatedStorage.ACS_Engine.Eventos.MedSys.Bandage
local event3 = game.ReplicatedStorage.ACS_Engine.Eventos.MedSys.AltBandage
local value = 300
local module = {
...
--//Client Animations
	...
	ChamberAnim = function(char, speed, objs)
		objs[5].Open.Transparency = 1
		objs[5].Close.Transparency = 0
		if value > 0 then
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Equip"):Play()
			ts(objs[2],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.074,-0.337,-1.471) * CFrame.Angles(math.rad(-112.924),math.rad(-4.309),math.rad(-44.570))}):Play()
			ts(objs[3],TweenInfo.new(0.45,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.525,0.141,-0.624) * CFrame.Angles(math.rad(-121.193),math.rad(29.245),math.rad(64.151))}):Play()
			wait(.35)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Open"):Play()
			objs[5].Open.Transparency = 0
			objs[5].Close.Transparency = 1
			ts(objs[3],TweenInfo.new(0.5,Enum.EasingStyle.Back,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.525,0.141,-0.624) * CFrame.Angles(math.rad(-121.193),math.rad(29.245),math.rad(64.151))}):Play()
			wait(.1)
			ts(objs[3],TweenInfo.new(0.45,Enum.EasingStyle.Back,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.396,-0.736,-1.369) * CFrame.Angles(math.rad(-119.327),math.rad(2.020),math.rad(-68.698))}):Play()
			wait(.3)	
			
			
			
			ts(objs[2],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.357,-0.764,-1.396) * CFrame.Angles(math.rad(-123.952),math.rad(0.118),math.rad(-67.612))}):Play()
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.029,-0.638,-1.340) * CFrame.Angles(math.rad(-124.048),math.rad(23.816),math.rad(45.428))}):Play()
			wait(.35)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Take"):Play()
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.182,-0.131,-1.102) * CFrame.Angles(math.rad(-169.373),math.rad(35.703),math.rad(90.205))}):Play()
		wait(.35)
			ts(objs[3],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.447,-0.558,-1.439) * CFrame.Angles(math.rad(58.500),math.rad(73.658),math.rad(-162.244))}):Play()
		wait(.35)
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.75,0.05,-1) * CFrame.Angles(math.rad(-100),math.rad(50),math.rad(7.5))}):Play()
		wait(0.3)
			if player.Character:WaitForChild("Saude").Variaveis.HeavyBleed.Value == true then
				value = value - ((player.Character:WaitForChild("Humanoid").MaxHealth/player.Character:WaitForChild("Humanoid").Health) * 10 + 210)
				event3:FireServer()
			elseif player.Character:WaitForChild("Saude").Variaveis.HeavyBleed.Value == false and player.Character:WaitForChild("Saude").Stances.Sangrando.Value == true then
				value = value - ((player.Character:WaitForChild("Humanoid").MaxHealth/player.Character:WaitForChild("Humanoid").Health) * 10 + 30)
				event2:FireServer()
			else
				value = value - ((player.Character:WaitForChild("Humanoid").MaxHealth/player.Character:WaitForChild("Humanoid").Health) * 10)
			end
			event:FireServer()
			print(value)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Use"):Play()
			ts(objs[2],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.5, -0.5, 0) * CFrame.Angles(math.rad(-15), math.rad(-90), math.rad(-20))}):Play()
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.3,-.15,-.5) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.5,-0.15,-1) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.3,-0.15,-1.5) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0,-0.15,-1) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.3,-.15,-.5) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.5,-0.15,-1) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			...
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0,-0.15,-1) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("End"):Play()
			objs[5].Open.Transparency = 1
			objs[5].Close.Transparency = 0
		elseif value <= 0 then
