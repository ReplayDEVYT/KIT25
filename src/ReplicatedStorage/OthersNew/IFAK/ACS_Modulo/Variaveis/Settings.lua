...
----------------------------------------------------------------------------------------------------
	...
	,TorsoDamage = {70,75}
	,HeadDamage = {130,140}
	,BulletPenetration = 13			 ---- Between 0 & 100%
	,FallOfDamage = 1
----------------------------------------------------------------------------------------------------
-------------------=[ PROJETIL ]=-------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------
	...
	,RightPos = CFrame.new(-0.323,0.780,-1.093) * CFrame.Angles(math.rad(-90.000),math.rad(0.000),math.rad(-22.000))	--Client
	,LeftPos = CFrame.new(1.148,0.684,-1.153) * CFrame.Angles(math.rad(-87.000),math.rad(19.000),math.rad(-14.000))	--Client
}
