...
local event = game.ReplicatedStorage.ACS_Engine.Eventos.MedSys.Surgical
local value = 5
local module = {
...
--//Client Animations
	...
	ChamberAnim = function(char, speed, objs)
		...
		ts(objs[2],TweenInfo.new(0.5),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.1, 0, 0) * CFrame.Angles(math.rad(-15), math.rad(0), math.rad(-20))}):Play()
			...
			ts(objs[3],TweenInfo.new(0.45),{C1 = CFrame.new(0.15,0.1,-1.2) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
			wait(.65)
			local MagC = objs[5]:WaitForChild("Tweezers"):clone()
			...
			wait(0.35)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Tweezers"):Play()
			wait(0.75)
			ts(objs[3],TweenInfo.new(0.45),{C1 = CFrame.new(0.15,0.1,-1.2) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
			wait(.45)
			MagC:Destroy()
			wait(0.65)
			local MagC2 = objs[5]:WaitForChild("Scissors"):clone()
			...
			MagCW2.Parent = MagC2
			MagCW2.C1 = MagC2.CFrame:toObjectSpace(objs[3].Parent.Parent:WaitForChild("Left Arm").CFrame)
			ts(MagCW2,TweenInfo.new(0),{C0 = CFrame.new(0.21, -0.4, -0.75) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(180))}):Play()
			ts(objs[3],TweenInfo.new(.75),{C1 = CFrame.new(0,-0.65,-2) * CFrame.Angles(math.rad(-75),math.rad(55),math.rad(30))}):Play()
			wait(0.35)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Snap"):Play()
			wait(0.4)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Snap"):Play()
			wait(0.3)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Snap"):Play()
			...
			MagC2:Destroy()
			wait(0.65)
			local MagC3 = objs[5]:WaitForChild("Stapler"):clone()
			MagC3.Parent = workspace.CurrentCamera
			MagC3.Name = "MagC"
			MagC3.Transparency = 0			

			local MagCW3 = Instance.new("Motor6D")
			MagCW3.Part0 = MagC3
			MagCW3.Part1 = objs[3].Parent.Parent:WaitForChild("Left Arm")
			MagCW3.Parent = MagC3
			MagCW3.C1 = MagC3.CFrame:toObjectSpace(objs[3].Parent.Parent:WaitForChild("Left Arm").CFrame)
			ts(MagCW3,TweenInfo.new(0),{C0 = CFrame.new(0.21, -0.4, -0.75) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(180))}):Play()
			ts(objs[3],TweenInfo.new(.75),{C1 = CFrame.new(0,-0.65,-2) * CFrame.Angles(math.rad(-75),math.rad(55),math.rad(30))}):Play()
			wait(0.35)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Staple"):Play()
			wait(0.25)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Staple2"):Play()
			wait(1)
			ts(objs[3],TweenInfo.new(0.45),{C1 = CFrame.new(0.15,0.1,-1.2) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
			wait(.45)
			MagC3:Destroy()
