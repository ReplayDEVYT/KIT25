...
--//Client Animations
	...
	ChamberCheckAnim = function(char, speed, objs)
		ts(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(0.35, -0.6, -1) * CFrame.Angles(math.rad(-90), math.rad(20), math.rad(-75))}):Play()
		ts(objs[3],TweenInfo.new(0.4),{C1 = CFrame.new(0.2,0.6,-0.9) * CFrame.Angles(math.rad(-110),math.rad(20),math.rad(20))}):Play()
		wait(0.4)    
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
		ts(objs[3],TweenInfo.new(0.25),{C1 = CFrame.new(0,0.2,-0.9) * CFrame.Angles(math.rad(-110),math.rad(20),math.rad(20))}):Play()
		...
		ts(objs[3],TweenInfo.new(0.1),{C1 = CFrame.new(0,0.25,-0.95) * CFrame.Angles(math.rad(-110),math.rad(20),math.rad(20))}):Play()
		...
		if objs[7].Value <= 0 then
			...
			ts(objs[2],TweenInfo.new(0.2),{C1 = CFrame.new(-0.875, -0.465, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
			ts(objs[3],TweenInfo.new(0.2),{C1 = CFrame.new(0.4,0.45,-1.115) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()

			wait(0.2)

			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
			ts(objs[3],TweenInfo.new(0.1),{C1 = CFrame.new(0.26,0,-1) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()
			ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.1),{C0 = CFrame.new(0, 0, 0.38) * CFrame.Angles(0,math.rad(0),0)}):Play()
			wait(.1)
			ts(objs[3],TweenInfo.new(0.1),{C1 = CFrame.new(0.26,0,-0.85) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()
			ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.1),{C0 = CFrame.new(0.01, 0.02, 0.38) * CFrame.Angles(0,math.rad(0),0)}):Play()
			wait(.1)

			ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-.85, -0.4, -0.8) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(22.5))}):Play()
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.4,0.3,-1.5) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(15))}):Play()
			wait(0.3)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagOut"):Play()
			objs[5]:WaitForChild("Mag").Transparency = 1

			ts(objs[2],TweenInfo.new(0.1,Enum.EasingStyle.Quad,Enum.EasingDirection.In),{C1 = CFrame.new(-.85, -0.4, -0.9) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(15))}):Play()
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.4,0.3,-3) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(50))}):Play()
			wait(0.1)
			ts(objs[2],TweenInfo.new(0.1),{C1 = CFrame.new(-.85, -0.2, -0.85) * CFrame.Angles(math.rad(-80), math.rad(0), math.rad(15))}):Play()
			wait(0.1)
			ts(objs[2],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{C1 = CFrame.new(-.85, -0.2, -0.92) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(15))}):Play()
			ts(objs[3],TweenInfo.new(0),{C1 = CFrame.new(-0.3,0.3,-2.3) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(0))}):Play()
			wait(0.4)
			...
			ts(objs[3],TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.In),{C1 = CFrame.new(-0.6,0.5,-1.8) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(15))}):Play()
			wait(0.2)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagIn"):Play()
			objs[5]:WaitForChild("Mag").Transparency = 0
			ts(objs[2],TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{C1 = CFrame.new(-.65, -0.25, -0.95) * CFrame.Angles(math.rad(-93), math.rad(0), math.rad(0))}):Play()
			ts(objs[3],TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{C1 = CFrame.new(-0.65,0.55,-1.5) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(15))}):Play()
			wait(0.2)
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.42,0.1,-0.7) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()
			wait(.3)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlideRelease"):Play()
			ts(objs[3],TweenInfo.new(0.1),{C1 = CFrame.new(0.42,0.1,-1) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()
			ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.1),{C0 = CFrame.new(0, 0, 0.38) * CFrame.Angles(0,math.rad(0),0)}):Play()
			wait(.1)
			ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.1),{C0 = CFrame.new(0, 0, 0) * CFrame.Angles(0,math.rad(0),0)}):Play()
