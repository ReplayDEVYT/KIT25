...
-----------------=[ RECOIL & PRECISAO ]=------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	,VRecoil = {14,20}				--- Vertical Recoil
	,HRecoil = {5,9}				--- Horizontal Recoil
	,AimRecover = 0.3				---- Between 0 & 1
	,rMain = 0.09					--dont even change this
	,hStep = {-.71,.71}				--horizontalStep, horizontal spread of the weapon
	,tStep = 0.21					--timeStep, might not wanna change this
	,vStep = {2.6,3.6}					--verticalStep, ok you probably shouldnt change any of these
	,RecoilPunch = 1
	,VPunchBase = 1.8				--- Vertical Punch
	...
	,MaxSpread = 0.4					--- Max bullet spread value | Studs
	,AimInaccuracyStepAmount = .25
	,WalkMultiplier = 0				--- Bullet spread based on player speed

	,SwayBase = 0.01				--- Weapon Base Sway | Studs
	,MaxSway =	0.1					--- Max sway value based on player stamina | Studs
	----------------------------------------------------------------------------------------------------
	---------------------=[ DANO ]=---------------------------------------------------------------------
	----------------------------------------------------------------------------------------------------
	,LimbsDamage = {62,72}
	,TorsoDamage = {77,97}
	,HeadDamage = {130,240}
	,BulletPenetration = 88			 ---- Between 0 & 100%
	,FallOfDamage = 0.35
	----------------------------------------------------------------------------------------------------
	-------------------=[ PROJETIL ]=-------------------------------------------------------------------
	----------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------
	...
	,BoltExtend = Vector3.new(0, 0, 1)
	,SlideExtend = Vector3.new(0, 0, 1)	
----------------------------------------------------------------------------------------------------
--------------------=[ CFRAME ]=--------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	,EnableHolster = false
	...
	,LeftPos = CFrame.new(1.4,0.45,-1.75) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-30))    --Client
}
