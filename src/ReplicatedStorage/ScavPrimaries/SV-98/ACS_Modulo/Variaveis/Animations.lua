...
--//Client Animations
	...
	UnZoomAnim = function(char, speed, objs)
		...
		SprintAnim = function(char, speed, objs)
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-.875, -0.2, -1.75) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(0))}):Play()
		...
		ts(objs[3],TweenInfo.new(0.25),{C1 = require(script.Parent.Settings).LeftPos * CFrame.new(0.35, 0.25, -0.35) * CFrame.Angles(math.rad(0), math.rad(5), math.rad(-10))}):Play()
		...
		ts(objs[3],TweenInfo.new(0.25),{C1 = require(script.Parent.Settings).LeftPos * CFrame.new(0.35, 0.35, -0.35) * CFrame.Angles(math.rad(0), math.rad(5), math.rad(-10))}):Play()
			wait(0.2)
