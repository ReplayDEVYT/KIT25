...
-----------------=[ RECOIL & PRECISAO ]=------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	,VRecoil = {11,24}				--- Vertical Recoil
	,HRecoil = {6,9}				--- Horizontal Recoil
	,AimRecover = .45				---- Between 0 & 1
	...
	,MaxSpread = 1					--- Max bullet spread value | Studs
	...
	,TorsoDamage = {154,154}
	,HeadDamage = {154,154}
	,BulletPenetration = 42			 ---- Between 0 & 100%
	,FallOfDamage = .9
	----------------------------------------------------------------------------------------------------
	-------------------=[ PROJETIL ]=-------------------------------------------------------------------
	----------------------------------------------------------------------------------------------------
	...
	,Tracer = false
	,TracerColor = Color3.fromRGB(155,255,155)
	...
	,BulletLightColor = Color3.fromRGB(155,255,155)
	,BulletLightRange = 10
