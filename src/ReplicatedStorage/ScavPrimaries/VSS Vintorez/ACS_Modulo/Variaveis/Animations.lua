...
--//Client Animations
	...
	AimAnim = function(char, speed, objs)
		...
		objs[5].Scope3.Transparency = 1
		objs[5].Sight1.Transparency = 1
		objs[5].Sight2.Transparency = 1
		--objs[5].Sight3.Transparency = 1
	...
	UnAimAnim = function(char, speed, objs)
		...
		objs[5].Scope3.Transparency = 0
		objs[5].Sight1.Transparency = 0
		objs[5].Sight2.Transparency = 0
		--objs[5].Sight3.Transparency = 0
	...
	ZoomAnim = function(char, speed, objs)
		...
		wait(0.15)
		objs[5].ProjectorSight.SurfaceGui.ClippingFrame.Reticle.ImageColor3 = Color3.fromRGB(0,0,0)
	...
	UnZoomAnim = function(char, speed, objs)
		...
		ts(objs[2],TweenInfo.new(0.15),{C1 = require(script.Parent.Settings).RightPos}):Play() 
		wait(0.15)
		objs[5].ProjectorSight.SurfaceGui.ClippingFrame.Reticle.ImageColor3 = Color3.fromRGB(255,255,255)
		objs[5].Handle:WaitForChild("AimDown"):Play()
		wait(0.3)
	end;
