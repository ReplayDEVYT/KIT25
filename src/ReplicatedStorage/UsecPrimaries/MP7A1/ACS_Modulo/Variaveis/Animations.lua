...
--//Client Animations
		...
		SprintAnim = function(char, speed, objs)
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-1, -.75, -1.25) * CFrame.Angles(math.rad(-160), math.rad(0), math.rad(0))}):Play()
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.805950999, 0.654529691, -1.92835355, 0.999723792, 0.0109803826, 0.0207702816, -0.0223077796, 0.721017241, 0.692557871, -0.00737112388, -0.692829967, 0.721063137)}):Play()
			wait(0.3)	
		end;
	...
	EquipAnim = function(char, speed, objs)
		if equipped == false then
			...
			ts(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(.5, 0.3, -1) * CFrame.Angles(math.rad(-95), math.rad(10), math.rad(-75))}):Play()
			ts(objs[3],TweenInfo.new(0.55),{C1 = CFrame.new(0.3,-0.5,-10.7) * CFrame.Angles(math.rad(-120),math.rad(70),math.rad(15))}):Play()
			wait(.45)--0.35    
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("BoltRel"):Play()

			ts(objs[2],TweenInfo.new(0.1),{C1 = CFrame.new(.5, 0.4, -1) * CFrame.Angles(math.rad(-93), math.rad(7), math.rad(-78))}):Play()
			ts(objs[3],TweenInfo.new(0.15),{C1 = CFrame.new(0.3,-0.5,-10.7) * CFrame.Angles(math.rad(-120),math.rad(70),math.rad(15))}):Play()
	...
	ZoomAnim = function(char, speed, objs)
		if sightmode == 1 then
			objs[5].ProjectorSight.SurfaceGui.ClippingFrame.Reticle.Image = "rbxassetid://5847765187"
		elseif sightmode == 2 then
			objs[5].ProjectorSight.SurfaceGui.ClippingFrame.Reticle.Image = "rbxassetid://5847765067"
		elseif sightmode == 3 then
			objs[5].ProjectorSight.SurfaceGui.ClippingFrame.Reticle.Image = "rbxassetid://6290023910"
		end
		if sightmode < 4 and (sightmode+1) < 4 then
			sightmode = sightmode + 1
		elseif sightmode >= 4 or (sightmode+1) >= 4 then
			sightmode = 1
		end
	...
	ChamberBKAnim = function(char, speed, objs)
		ts(objs[2],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(.5, 0.3, -1) * CFrame.Angles(math.rad(-95), math.rad(10), math.rad(-75))}):Play()
		ts(objs[3],TweenInfo.new(0.55,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.3,-0.5,-10.7) * CFrame.Angles(math.rad(-120),math.rad(70),math.rad(15))}):Play()
		wait(.45)--0.35    
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("BoltRel"):Play()

		ts(objs[2],TweenInfo.new(0.1,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(.5, 0.4, -1) * CFrame.Angles(math.rad(-93), math.rad(7), math.rad(-78))}):Play()
		ts(objs[3],TweenInfo.new(0.15,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.3,-0.5,-10.7) * CFrame.Angles(math.rad(-120),math.rad(70),math.rad(15))}):Play()
		ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.1,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
		ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.1,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
		wait(.1)
		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(.5, 0.35, -1) * CFrame.Angles(math.rad(-95), math.rad(10), math.rad(-75))}):Play()
		wait(.2)--0.2
		...
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = require(script.Parent.Settings).LeftPos}):Play()
	end;

	CheckAnim = function(char, speed, objs)
		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.875, 0.5, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
	...
	ReloadAnim = function(char, speed, objs)
		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.975, 0.425, -0.75) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(30))}):Play()
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.35,-0.95,-1.45) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
		wait(0.3)	
		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.975, 0.425, -0.75) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(30))}):Play()
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.2,-1.5,-1.65) * CFrame.Angles(math.rad(-125),math.rad(75),math.rad(15))}):Play()
		...
		ts(objs[3],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.195,1.4,-0.5) * CFrame.Angles(math.rad(0),math.rad(25),math.rad(0))}):Play()
		wait(0.75)
		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.975, 0.425, -0.75) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(30))}):Play()
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.2,-1.5,-1.65) * CFrame.Angles(math.rad(-125),math.rad(75),math.rad(15))}):Play()
		wait(0.3)
