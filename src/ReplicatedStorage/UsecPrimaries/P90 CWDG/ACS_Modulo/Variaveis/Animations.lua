...
--//Client Animations
	...
	FiremodeAnim = function(char, speed, objs)
		...
		ts(objs[2],TweenInfo.new(0.20,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-.65, -0.2, -1) * CFrame.Angles(math.rad(-89), math.rad(-1), math.rad(-1))}):Play()
		ts(objs[3],TweenInfo.new(0.20,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.9,-0.4,-1.4) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-18))}):Play()
		wait(0.20)
		ts(objs[2],TweenInfo.new(0.20,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-.65, -0.2, -1) * CFrame.Angles(math.rad(-90.5), math.rad(0.5), math.rad(0.5))}):Play()
		ts(objs[3],TweenInfo.new(0.20,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.9,-0.4,-1.4) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-18))}):Play()
		wait(0.20)
		ts(objs[2],TweenInfo.new(0.20,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-.65, -0.2, -1) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(0))}):Play()
		ts(objs[3],TweenInfo.new(0.20,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.9,-0.4,-1.4) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-18))}):Play()
		wait(0.20)
	end;
	...
	ChamberCheckAnim = function(char, speed, objs)
		ts(objs[2],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.35, -0.6, -1) * CFrame.Angles(math.rad(-90), math.rad(20), math.rad(-75))}):Play()
		ts(objs[3],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.2,0.6,-0.9) * CFrame.Angles(math.rad(-110),math.rad(20),math.rad(20))}):Play()
		wait(0.4)    
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
		ts(objs[3],TweenInfo.new(0.25,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0,0.2,-0.9) * CFrame.Angles(math.rad(-110),math.rad(20),math.rad(20))}):Play()
		...
		ts(objs[3],TweenInfo.new(0.1,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0,0.25,-0.95) * CFrame.Angles(math.rad(-110),math.rad(20),math.rad(20))}):Play()
	...
	ChamberAnim = function(char, speed, objs)
		ts(objs[2],TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.875, -0.465, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
		ts(objs[3],TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.4,0.45,-1.115) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()

		wait(0.2)

		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
		ts(objs[3],TweenInfo.new(0.25,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.26,0,-1) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()
		ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.25,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C0 = CFrame.new(require(script.Parent.Settings).BoltExtend) * CFrame.Angles(0,math.rad(0),0)}):Play()
		ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.25,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C0 = CFrame.new(require(script.Parent.Settings).SlideExtend) * CFrame.Angles(0,math.rad(0),0)}):Play()
		wait(.2)
		ts(objs[3],TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.4,0.45,-1.115) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()
		ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.1,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
		ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.1,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlideRelease"):Play()
		wait(0.1)
		ts(objs[3],TweenInfo.new(0.35,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = require(script.Parent.Settings).LeftPos}):Play()
		ts(objs[2],TweenInfo.new(0.35,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = require(script.Parent.Settings).RightPos}):Play() 
	end;
	...
	CheckAnim = function(char, speed, objs)
		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.975, 0.325, -0.75) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(30))}):Play()
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.5,-0.3,-1) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
		wait(.35)
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.5,-0.3,-0.8) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagOut"):Play()
		wait(0.3)
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.5,-0.3,-0.6) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
		wait(1)
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.5,-0.3,-1) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
		wait(0.3)
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.5,-0.3,-1) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
	...
	ReloadAnim = function(char, speed, objs)
		...
		wait(0.15)
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.5,-0.3,-0.8) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
		--ts(objs[3],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.3,0.3,-2.3) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(0))}):Play()
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagOut"):Play()
		objs[5].Mag.Transparency = 1

		wait(0.05)

		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.975, 0.325, -0.75) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(30))}):Play()
		ts(objs[3],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.3,0.3,-2.3) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(0))}):Play()
		wait(0.2)
		ts(objs[2],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.In),{C1 = CFrame.new(-.85, -0.4, -0.9) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(15))}):Play()
		wait(0.4)
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagPouch"):Play()
		ts(objs[2],TweenInfo.new(0.4),{C1 = CFrame.new(-.85, -0.2, -0.85) * CFrame.Angles(math.rad(-80), math.rad(0), math.rad(15))}):Play()
		wait(0.4)
		ts(objs[2],TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{C1 = CFrame.new(-.85, -0.2, -0.92) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(15))}):Play()
		wait(0.2)
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagGrab"):Play()
		ts(objs[2],TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.In),{C1 = CFrame.new(-.65, -0.2, -0.7) * CFrame.Angles(math.rad(-80), math.rad(0), math.rad(5))}):Play()
		wait(0.2)
		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.975, 0.325, -0.75) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(30))}):Play()
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.5,-0.65,-0.1) * CFrame.Angles(math.rad(-125),math.rad(75),math.rad(15))}):Play()
		wait(0.3)
		ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.975, 0.325, -0.75) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(30))}):Play()
		ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.5,-0.3,-1) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagIn"):Play()
