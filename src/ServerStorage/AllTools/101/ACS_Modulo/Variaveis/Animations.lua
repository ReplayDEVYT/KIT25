...
--//Client Animations
	...
	CheckWatch = function(char, speed, objs)
		...
		if sightmode == 1 then
			objs[5].ProjectorSight.SurfaceGui.ClippingFrame.Reticle.Image = "rbxassetid://6284491750"
	...
	ReloadAnim = function(char, speed, objs)
		...
		if objs[7].Value <= 0 then
			...
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-0.875, 0, -1.2) * CFrame.Angles(math.rad(-100), math.rad(-2), math.rad(7.5))}):Play()
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(-0.42,0.475,-1.6) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()
			wait(0.5)	
			ts(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(-0.875, 0, -1.35) * CFrame.Angles(math.rad(-105), math.rad(-2), math.rad(7.5))}):Play()
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(-0.42,0.475,-2.25) * CFrame.Angles(math.rad(-110),math.rad(0),math.rad(7.5))}):Play()
			objs[5].Mag.Transparency = 1
			objs[5].Handle:WaitForChild("MagOut"):Play()
