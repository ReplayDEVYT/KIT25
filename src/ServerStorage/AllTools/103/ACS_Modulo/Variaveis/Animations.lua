...
--//Client Animations
	...
	CheckWatch = function(char, speed, objs)
		...
		ZoomAnim = function(char, speed, objs)
			...
			ts(objs[5].g33:WaitForChild("g33"),TweenInfo.new(0.3),{C1 = CFrame.new(-0.11, 0.242, 0)*CFrame.Angles(0, 0, math.rad(90))*CFrame.new(0.225, -0.75, 0)}):Play()
			wait(0.3)
		end;
		...
		UnZoomAnim = function(char, speed, objs)
			...
			wait(0.3)
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(-0.65, -0.7, -1)*CFrame.Angles(math.rad(-180), 0, 0)*CFrame.Angles(0, 0, math.rad(30))}):Play()
			ts(objs[5].g33:WaitForChild("g33"),TweenInfo.new(0.3),{C1 = CFrame.new(0, 0, 0)*CFrame.Angles(0, 0, math.rad(0))*CFrame.new(0, 0, 0)}):Play()
			wait(0.3)
		end;
