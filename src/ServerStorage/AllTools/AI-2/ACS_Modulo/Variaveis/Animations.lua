...
--//Client Animations
	...
	ChamberAnim = function(char, speed, objs)
		...
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.75,0.155,-1) * CFrame.Angles(math.rad(-100),math.rad(50),math.rad(7.5))}):Play()
		wait(.35)
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.75,0.155,-0.35) * CFrame.Angles(math.rad(-100),math.rad(50),math.rad(0))}):Play()
		wait(.35)
		ts(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(0.15,0.1,-1.2) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
		wait(.6)
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.75,0.05,-1) * CFrame.Angles(math.rad(-100),math.rad(50),math.rad(7.5))}):Play()
		wait(0.3)
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.4,0.05,-1) * CFrame.Angles(math.rad(-100),math.rad(50),math.rad(7.5))}):Play()
			event:FireServer()
			value = value - (player.Character:WaitForChild("Humanoid").Health/player.Character:WaitForChild("Humanoid").MaxHealth)
			print((player.Character:WaitForChild("Humanoid").Health/player.Character:WaitForChild("Humanoid").MaxHealth))
			wait(2.5)
		elseif value <= 0 then
