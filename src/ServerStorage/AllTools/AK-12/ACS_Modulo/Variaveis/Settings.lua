...
-----------------=[ RECOIL & PRECISAO ]=------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	,VRecoil = {6,8}				--- Vertical Recoil
	,HRecoil = {1,2.5}				--- Horizontal Recoil
	,AimRecover = .7				---- Between 0 & 1
	,rMain = 0.125					--dont even change this
	,hStep = {-.45,.45}				--horizontalStep, horizontal spread of the weapon
	,tStep = 0.1					--timeStep, might not wanna change this
	,vStep = {2,2.25}					--verticalStep, ok you probably shouldnt change any of these
	,RecoilPunch = .15
	...
	,TorsoDamage = {70,75}
	,HeadDamage = {130,140}
	,BulletPenetration = 49			 ---- Between 0 & 100%
	,FallOfDamage = 1
	----------------------------------------------------------------------------------------------------
	-------------------=[ PROJETIL ]=-------------------------------------------------------------------
	----------------------------------------------------------------------------------------------------
