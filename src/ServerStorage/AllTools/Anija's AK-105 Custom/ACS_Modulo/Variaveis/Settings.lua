...
---------------------=[ GERAL ]=--------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	 Name = "Anija 'Ani' Airashi's Custom AK-105 w/ 30 rnd. AK-12 magazine"
...
----------------------------------------------------------------------------------------------------
	...
	,hStep = {-.25,.25}				--horizontalStep, horizontal spread of the weapon
	,tStep = 0.1					--timeStep, might not wanna change this
	,vStep = {1.5,2}					--verticalStep, ok you probably shouldnt change any of these
	,RecoilPunch = .15
	...
	,BulletLightColor = Color3.fromRGB(255,55,55)
	,BulletLightRange = 10
