...
--//Server Animations
	...
	RightChamberState1 = CFrame.new(-0.775, 0.05, -1.25) * CFrame.Angles(math.rad(-90), math.rad(-2), math.rad(2));
	LeftChamberState1 = CFrame.new(-0.65,-1.35,-2.25) * CFrame.Angles(math.rad(-180),math.rad(15),math.rad(15));												

	LeftChamberState2 = CFrame.new(-0.7,-1.35,-1.5) * CFrame.Angles(math.rad(-180),math.rad(15),math.rad(15));
