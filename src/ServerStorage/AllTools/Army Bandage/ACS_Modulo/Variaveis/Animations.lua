...
local event = game.ReplicatedStorage.ACS_Engine.Eventos.MedSys.AltBandage
local value = 2
local module = {
...
--//Client Animations
	...
	ChamberAnim = function(char, speed, objs)
		...
		ts(objs[2],TweenInfo.new(0.5),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.1, 0, 0) * CFrame.Angles(math.rad(-15), math.rad(0), math.rad(-20))}):Play()
			...
			event:FireServer()
			value = value - 1
			ts(objs[2],TweenInfo.new(0.5),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.5, -0.5, 0) * CFrame.Angles(math.rad(-15), math.rad(-90), math.rad(-20))}):Play()
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.3,-.15,-.5) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
		wait(0.225)
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.5,-0.15,-1) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.3,-0.15,-1.5) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0,-0.15,-1) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.3,-.15,-.5) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
			wait(0.225)
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.5,-0.15,-1) * CFrame.Angles(math.rad(-100),math.rad(80),math.rad(7.5))}):Play()
