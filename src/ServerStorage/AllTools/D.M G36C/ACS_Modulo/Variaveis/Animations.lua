...
--//Client Animations
	...
	ChamberCheckAnim = function(char, speed, objs)
		...
		ts(objs[3],TweenInfo.new(0.35),{C1 = CFrame.new(0.05,0.25,-1.2) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
		wait(0.35)	
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
		ts(objs[3],TweenInfo.new(0.25),{C1 = CFrame.new(-0.05,-0.05,-1.05) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
