...
--//Client Animations
		...
		StanceUp = function(char, speed, objs)
		    ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-.875, -1, -1.25) * CFrame.Angles(math.rad(-160), math.rad(0), math.rad(0))}):Play()
		...
		Patrol = function(char, speed, objs)
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-0.75, 0.1, -1.6) * CFrame.Angles(math.rad(-80), math.rad(-70), math.rad(0))}):Play()
	...
	ChamberAnim = function(char, speed, objs)
		...
		ts(objs[3],TweenInfo.new(0.35),{C1 = CFrame.new(1.8,-1.2,-0.85) * CFrame.Angles(math.rad(-180),math.rad(90),math.rad(0))}):Play()
		wait(.35)	
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
		ts(objs[3],TweenInfo.new(0.25),{C1 = CFrame.new(1.25,-1.2,-0.85) * CFrame.Angles(math.rad(-180),math.rad(90),math.rad(0))}):Play()
		...
		CheckAnim = function(char, speed, objs)
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-0.8, 1, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
		    ...
		    ts(MagCW,TweenInfo.new(0),{C0 = CFrame.new(-0.75, -0.35, -0.2) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(90))}):Play()
		ts(objs[3],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.45,0.475,-2.05) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagOut"):Play()
			wait(0.3)
		ts(objs[3],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.15,0.475,-1.5) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(0))}):Play()
			wait(1.5)
	...
	ReloadAnim = function(char, speed, objs)
		ts(objs[2],TweenInfo.new(0.4),{C1 = CFrame.new(-0.875, 0.8, -1.15) * CFrame.Angles(math.rad(-94), math.rad(-2), math.rad(7))}):Play()
		ts(objs[3],TweenInfo.new(0.4),{C1 = CFrame.new(-0.518,0.2,-1.6) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()
		--Left+Right Reload 1
		wait(0.5)	
		objs[5].Mag.Transparency = 1
		local MagC = objs[5]:WaitForChild("Mag"):clone()
		...
		ts(MagCW,TweenInfo.new(0),{C0 = CFrame.new(-0.75, -0.35, -0.2) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(90))}):Play()
		ts(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(-0.8725, 0.823, -1.18) * CFrame.Angles(math.rad(-91), math.rad(-4), math.rad(6))}):Play()
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(-0.518,0.255,-2.4) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()
		--Left+Right Reload 2
		wait(.05)

		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagOut"):Play()
		wait(0.25)
		ts(objs[2],TweenInfo.new(0.7),{C1 = CFrame.new(-0.82, 0.81, -1.14) * CFrame.Angles(math.rad(-91), math.rad(-2), math.rad(7))}):Play()
		ts(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(-0.65,0.275,-3.05) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(25.5))}):Play()
		--Left+Right Reload 3
		wait(0.5)
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagGrab"):Play()
		ts(objs[2],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-.85, -0.4, -0.8) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(22.5))}):Play()
		wait(0.6)
		ts(objs[2],TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(-0.80, 0.803, -1.13) * CFrame.Angles(math.rad(-90), math.rad(-3), math.rad(8))}):Play()
		...
		wait(0.2)
		ts(objs[3],TweenInfo.new(0.0),{C1 = CFrame.new(0.25,0.2,-3.05) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()	
		--//Left Reload 4
		wait(0.2)

		ts(objs[2],TweenInfo.new(0.7),{C1 = CFrame.new(-1.157, 0.823, -0.28) * CFrame.Angles(math.rad(-96), math.rad(-2), math.rad(45))}):Play()
		--//Right Reload 5
		wait(0.3)	

		ts(objs[2],TweenInfo.new(0.7),{C1 = CFrame.new(-0.875, 0.81, -0.3) * CFrame.Angles(math.rad(-97), math.rad(-3), math.rad(45))}):Play()
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(-0.518,0.2,-1.4) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(45.5))}):Play()
		--//RightReload6, LeftReload5
		wait(0.2)

		ts(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(-0.875, 0.803, -0.32) * CFrame.Angles(math.rad(-94), math.rad(-2), math.rad(45))}):Play()
		ts(objs[3],TweenInfo.new(0.2),{C1 = CFrame.new(-0.518,0.2,-1.4) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(45.5))}):Play()
		--//Above is where you bring the new mag back under the gun.
		--//RightReload7, LeftReload6
		wait(0.3)
		ts(objs[3],TweenInfo.new(0.2),{C1 = CFrame.new(-0.518,0.2,-0.85) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(45.5))}):Play()
		ts(objs[2],TweenInfo.new(0.2),{C1 = CFrame.new(-0.875, 0.8, -0.34) * CFrame.Angles(math.rad(-94), math.rad(-2), math.rad(45))}):Play()
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagIn"):Play()
	...
	GLReloadAnim = function(char, speed, objs)
		...
		wait(0.2)	
		ts(objs[3],TweenInfo.new(0.2),{C1 =  CFrame.new(0.8,-0.2,-1.4) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-20))}):Play()
		wait(0.2)
		ts(objs[5].Handle:WaitForChild("GL1"),TweenInfo.new(0.2),{C0 = CFrame.new(0,0,-0.5) * CFrame.Angles(0,math.rad(0),0)}):Play()
		ts(objs[5].Handle:WaitForChild("GL2"),TweenInfo.new(0.2),{C0 = CFrame.new(0,0,-0.5) * CFrame.Angles(0,math.rad(0),0)}):Play()
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("GLOut"):Play()
		ts(objs[3],TweenInfo.new(0.2),{C1 =  CFrame.new(1.2,0.2,-1.6) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-20))}):Play()
		local shell = objs[5]:WaitForChild("GShell"):Clone()
		objs[5]:WaitForChild("G").Transparency = 1
		objs[5]:WaitForChild("GShell").Transparency = 1
		shell:ClearAllChildren()
		shell.Anchored = false
		shell.CanCollide = true
		shell.CFrame = objs[5]:WaitForChild("GShell").CFrame
		shell.Parent = workspace.CurrentCamera
		wait(0.2)
		local MagC = objs[5]:WaitForChild("G"):clone()
		MagC.Parent = workspace.CurrentCamera
		MagC.Name = "MagC"
		MagC.Transparency = 1		
		local MagCW = Instance.new("Motor6D")
		...
		MagCW.Part1 = objs[3].Parent.Parent:WaitForChild("Left Arm")
		MagCW.Parent = MagC
		MagCW.C1 = MagC.CFrame:toObjectSpace(objs[5].G.CFrame)
		...
		wait(0.25)
		ts(objs[3],TweenInfo.new(0.2),{C1 =  CFrame.new(1.2,0.2,-1.6) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-20))}):Play()
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("GLIn"):Play()
		objs[5]:WaitForChild("G").Transparency = 0
		MagC:Destroy()
		ts(objs[5].Handle:WaitForChild("G"),TweenInfo.new(0.2),{C0 = CFrame.new(0,0,-0.5) * CFrame.Angles(0,math.rad(0),0)}):Play()
		wait(0.2)
		ts(objs[3],TweenInfo.new(0.2),{C1 = require(script.Parent.Settings).LeftPos}):Play()
		ts(objs[5].Handle:WaitForChild("GL1"),TweenInfo.new(0.15),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,0,0)}):Play()
		ts(objs[5].Handle:WaitForChild("GL2"),TweenInfo.new(0.15),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,0,0)}):Play()
		ts(objs[5].Handle:WaitForChild("G"),TweenInfo.new(0.15),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,0,0)}):Play()
		objs[5]:WaitForChild("GShell").Transparency = 0
		wait(0.55)
	end;
--//Server Animations
	RightHighReady = CFrame.new(-1, -0.1, -1.25) * CFrame.Angles(math.rad(-160), math.rad(0), math.rad(0));
	LeftHighReady = CFrame.new(.85,-0.35,-1.15) * CFrame.Angles(math.rad(-170),math.rad(60),math.rad(15));

	RightLowReady = CFrame.new(-1, 0.4, -1.25) * CFrame.Angles(math.rad(-60), math.rad(0), math.rad(0));
	LeftLowReady = CFrame.new(1.25,1.15,-1.35) * CFrame.Angles(math.rad(-60),math.rad(35),math.rad(-25));

	RightPatrol = CFrame.new(-1, 0.5, -1.4) * CFrame.Angles(math.rad(-80), math.rad(-80), math.rad(0));
	LeftPatrol = CFrame.new(1,1.25,-.75) * CFrame.Angles(math.rad(-90),math.rad(-45),math.rad(-25));
	
	RightAim = CFrame.new(-.575, 0.3, -1) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(0));
	LeftAim = CFrame.new(1.4,0.25,-1.45) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-25));
	
	RightSprint = CFrame.new(-1, 0.6, -1.25) * CFrame.Angles(math.rad(-60), math.rad(0), math.rad(0));
