...
--//Client Animations
	...
	ChamberAnim = function(char, speed, objs)
		ts(objs[2],TweenInfo.new(0.2),{C1 = CFrame.new(0.6, -1, -1) * CFrame.Angles(math.rad(-95), math.rad(30), math.rad(-60))}):Play()
		ts(objs[3],TweenInfo.new(0.2),{C1 = CFrame.new(0.3,-0.9,-0.7) * CFrame.Angles(math.rad(-120),math.rad(70),math.rad(15))}):Play()
		wait(0.15)	
		objs[5].Bolt:WaitForChild("SlidePull"):Play()
		ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(0.6, -1.25, -1) * CFrame.Angles(math.rad(-110), math.rad(30), math.rad(-60))}):Play()
	...
	CheckAnim = function(char, speed, objs)
		...
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(-0.4,0.275,-4) * CFrame.Angles(math.rad(-120),math.rad(0),math.rad(7.5))}):Play()
		objs[5].Handle:WaitForChild("MagOut"):Play()
		wait(0.3)
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.15,0.475,-2.5) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(0))}):Play()
		wait(1.5)
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(-0.4,0.275,-4) * CFrame.Angles(math.rad(-120),math.rad(0),math.rad(7.5))}):Play()
		wait(0.3)
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(-0.5,0.475,-2) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()
		...
		if objs[7].Value <= 0 then
			...
			wait(0.2)
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-0.975, 0.325, -0.75) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(30))}):Play()
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.5,-1,-0.3) * CFrame.Angles(math.rad(-125),math.rad(75),math.rad(15))}):Play()
			wait(0.3)
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-0.975, 0.325, -0.75) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(30))}):Play()
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.35,-0.65,-1) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
			objs[5].Handle:WaitForChild("MagIn"):Play()
			--MagC:Destroy()
			objs[5].Mag.Transparency = 0	
			...
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-0.975, 0.325, -0.75) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(30))}):Play()
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.35,-0.95,-0.75) * CFrame.Angles(math.rad(-130),math.rad(75),math.rad(15))}):Play()
			wait(0.3)	
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-0.975, 0.325, -0.75) * CFrame.Angles(math.rad(-85), math.rad(0), math.rad(30))}):Play()
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.2,-1.5,-1) * CFrame.Angles(math.rad(-125),math.rad(75),math.rad(15))}):Play()
