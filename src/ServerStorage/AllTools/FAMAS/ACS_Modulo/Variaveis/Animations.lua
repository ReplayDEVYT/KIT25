...
--//Client Animations
		...
		StanceUp = function(char, speed, objs)
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-.875, -1.1, -1.1) * CFrame.Angles(math.rad(-160), math.rad(0), math.rad(0))}):Play()
	...
	EquipAnim = function(char, speed, objs)
		...
		ChamberAnim = function(char, speed, objs)
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-.62, 0.6, -0.9) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(0))}):Play()
			ts(objs[3],TweenInfo.new(0.35),{C1 = CFrame.new(0.15,0.5,-1.25) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
			wait(0.35)	
			objs[5].Bolt:WaitForChild("SlidePull"):Play()
			ts(objs[3],TweenInfo.new(0.25),{C1 = CFrame.new(0.1,0.15,-1.05) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
...
--//Server Animations
	...
	RightLowReady = CFrame.new(-1, 0.6, -1.25) * CFrame.Angles(math.rad(-60), math.rad(0), math.rad(0));
	LeftLowReady = CFrame.new(1.25,1.15,-1.35) * CFrame.Angles(math.rad(-60),math.rad(35),math.rad(-25));

	RightPatrol = CFrame.new(-1, 0.3, -1.4) * CFrame.Angles(math.rad(-80), math.rad(-80), math.rad(0));
