...
--//Client Animations
	...
	ChamberCheckAnim = function(char, speed, objs)
		...
		wait(0.2)
		ts(objs[5].Handle:WaitForChild("GL1"),TweenInfo.new(0.2),{C0 = CFrame.new(0,0,-0.25) * CFrame.Angles(0,math.rad(0),0)}):Play()
		ts(objs[5].Handle:WaitForChild("GL2"),TweenInfo.new(0.2),{C0 = CFrame.new(0,0,-0.25) * CFrame.Angles(0,math.rad(0),0)}):Play()
