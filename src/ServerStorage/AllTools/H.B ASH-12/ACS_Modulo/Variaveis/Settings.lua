...
----------------------------------------------------------------------------------------------------
	...
	,HolsterPos = CFrame.new(-0.5,-0.2,-0.95) * CFrame.Angles(math.rad(-90),math.rad(60),math.rad(90))
	...
	,RightPos = CFrame.new(-.62, -0.15, -0.83) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(0))	--Client
