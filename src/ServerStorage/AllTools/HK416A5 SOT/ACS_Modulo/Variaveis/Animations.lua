...
--//Client Animations
	...
	ZoomAnim = function(char, speed, objs)
		...
		ts(objs[5].g33:WaitForChild("g33"),TweenInfo.new(0.3),{C1 = CFrame.new(-0.075, 0.25, 0)*CFrame.Angles(0, 0, math.rad(90))*CFrame.new(0.225, -0.75, 0)}):Play()
		wait(0.3)
	end;
	...
	ReloadAnim = function(char, speed, objs)
		...
		if objs[7].Value <= 0 then
			...
			MagCW.Part1 = objs[3].Parent.Parent:WaitForChild("Left Arm")
			MagCW.Parent = MagC
			MagCW.C1 = MagC.CFrame:toObjectSpace(objs[5].Mag.CFrame)MagCW.C1 = MagC.CFrame:toObjectSpace(objs[5].Mag.CFrame)
