...
--//Client Animations
	...
	ChamberAnim = function(char, speed, objs)
		...
		if value > 0 then
			...
			ts(objs[2],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.1, 0, 0) * CFrame.Angles(math.rad(-15), math.rad(0), math.rad(-20))}):Play()
			ts(objs[3],TweenInfo.new(0.45,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.15,0.1,-1.2) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
			wait(.35)
			...
			ts(objs[3],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0,-1.35,-1.5) * CFrame.Angles(math.rad(-180),math.rad(35),math.rad(20))}):Play()
			wait(.35)
			ts(objs[3],TweenInfo.new(0.45,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.15,0.1,-1.2) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
			wait(.3)	
			...
			ts(objs[2],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.1, 0, 0) * CFrame.Angles(math.rad(-15), math.rad(0), math.rad(-20))}):Play()
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.75,0.155,-1) * CFrame.Angles(math.rad(-100),math.rad(50),math.rad(7.5))}):Play()
			wait(.35)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("Take"):Play()
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.75,0.155,-0.35) * CFrame.Angles(math.rad(-100),math.rad(50),math.rad(0))}):Play()
		wait(.35)
			ts(objs[3],TweenInfo.new(0.5,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(0.15,0.1,-1.2) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
		wait(.35)
