...
--//Client Animations
	...
	ChamberCheckAnim = function(char, speed, objs)
		...
		if objs[7].Value <= 0 then
			...
			wait(0.2)
			ts(objs[2],TweenInfo.new(0.35),{C1 = CFrame.new(-0.875, -0.465, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
			ts(objs[3],TweenInfo.new(0.35),{C1 = CFrame.new(0.4,0.45,-1.115) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()
			wait(0.35)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
			ts(objs[3],TweenInfo.new(0.25),{C1 = CFrame.new(0.26,0,-1) * CFrame.Angles(math.rad(-110),math.rad(25),math.rad(0))}):Play()
			ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.25),{C0 = CFrame.new(require(script.Parent.Settings).BoltExtend) * CFrame.Angles(0,math.rad(0),0)}):Play()
			ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.25),{C0 = CFrame.new(require(script.Parent.Settings).SlideExtend) * CFrame.Angles(0,math.rad(0),0)}):Play()
			wait(.25)
			ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.1),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
			ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.1),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlideRelease"):Play()
