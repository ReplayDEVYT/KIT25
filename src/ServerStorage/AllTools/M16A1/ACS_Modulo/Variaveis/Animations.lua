...
--//Client Animations
		...
		ts(objs[2],TweenInfo.new(0.6),{C1 = CFrame.new(-1, -1, -0.5) * CFrame.Angles(math.rad(-160), math.rad(10), math.rad(0))}):Play()
		ts(objs[3],TweenInfo.new(0.6),{C1 = CFrame.new(-.7, 0.85, -0.95) * CFrame.Angles(math.rad(20),math.rad(0),math.rad(0))}):Play()
	end;
