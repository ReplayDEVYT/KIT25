...
local guiMain = Instance.new("BlurEffect") 
guiMain.Parent = workspace.CurrentCamera 
guiMain.Size = script.Parent.Blur.Value
guiMain.Name = "Stun"
...
local tween = TweenService:Create(guiMain, TweenInfo.new(script.Parent.Time.Value*2), {Size = 0})
tween:Play()
...
spawn(function()
	...
	local tween = TweenService:Create(stunSound, TweenInfo.new(2), {Volume = 0})
	tween:Play()
	game.Debris:AddItem(stunSound,2)
end)
