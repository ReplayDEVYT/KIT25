...
--//Client Animations
		...
		StanceUp = function(char, speed, objs)
			...
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(.65,-0.75,-1.15) * CFrame.Angles(math.rad(-170),math.rad(60),math.rad(15))}):Play()
			wait(0.3)	
		end;
	...
	ChamberCheckAnim = function(char, speed, objs)
		...
		ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.2),{C0 = CFrame.new(objs[6].BoltExtend) * CFrame.Angles(0,math.rad(0),0) - Vector3.new(0, 0, .25)}):Play()
		ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.2),{C0 = CFrame.new(objs[6].SlideExtend) * CFrame.Angles(0,math.rad(0),0) - Vector3.new(0, 0, .25)}):Play()
		wait(1)
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlideRelease"):Play()
		ts(objs[3],TweenInfo.new(0.15),{C1 = require(script.Parent.Settings).LeftPos}):Play()
		ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.15),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
		ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.15),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
		wait(0.15)
	end;
	ChamberAnim = function(char, speed, objs)
		if script.Parent.Ammo.Value > 0 and script.Parent.Ammo.Value < 4 then
		ts(objs[2],TweenInfo.new(0.25),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.1, 0, 0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(-10))}):Play()
			ts(objs[3],TweenInfo.new(0.2),{C1 = require(script.Parent.Settings).LeftPos}):Play()
			wait(0.2)	
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
			ts(objs[3],TweenInfo.new(0.2),{C1 =  CFrame.new(0.8,-0.2,-1.4) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-20))}):Play()
			ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.2),{C0 = CFrame.new(objs[6].BoltExtend) * CFrame.Angles(0,math.rad(0),0)}):Play()
			ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.2),{C0 = CFrame.new(objs[6].SlideExtend) * CFrame.Angles(0,math.rad(0),0)}):Play()
			wait(0.25)
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlideRelease"):Play()
			ts(objs[3],TweenInfo.new(0.15),{C1 = require(script.Parent.Settings).LeftPos}):Play()
			ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.15),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
		...
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
		ts(objs[3],TweenInfo.new(0.2),{C1 =  CFrame.new(0.8,-0.2,-1.4) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-20))}):Play()
		ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.2),{C0 = CFrame.new(require(script.Parent.Settings).BoltExtend) * CFrame.Angles(0,math.rad(0),0) - Vector3.new(0, 0, .25)}):Play()
		ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.2),{C0 = CFrame.new(require(script.Parent.Settings).SlideExtend) * CFrame.Angles(0,math.rad(0),0) - Vector3.new(0, 0, .25)}):Play()
		wait(1)
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlideRelease"):Play()
		ts(objs[3],TweenInfo.new(0.15),{C1 = require(script.Parent.Settings).LeftPos}):Play()
		ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.15),{C0 = CFrame.new(0,0,0) * CFrame.Angles(0,math.rad(0),0)}):Play()
	...
	ShellInsertAnim = function(char, speed, objs)
		if first and objs[7].Value <= 0 then
			first = false
			...
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("SlidePull"):Play()
			ts(objs[3],TweenInfo.new(0.2),{C1 =  CFrame.new(0.8,-0.2,-1.4) * CFrame.Angles(math.rad(-120),math.rad(35),math.rad(-20))}):Play()
			ts(objs[5].Handle:WaitForChild("Bolt"),TweenInfo.new(0.2),{C0 = CFrame.new(require(script.Parent.Settings).BoltExtend) * CFrame.Angles(0,math.rad(0),0)}):Play()
			ts(objs[5].Handle:WaitForChild("Slide"),TweenInfo.new(0.2),{C0 = CFrame.new(require(script.Parent.Settings).SlideExtend) * CFrame.Angles(0,math.rad(0),0)}):Play()
			wait(0.2)
			...
			ts(objs[3],TweenInfo.new(0.25,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.25,-1.2,-0.85) * CFrame.Angles(math.rad(-180),math.rad(90),math.rad(0))}):Play()
			wait(0.4)
			ts(objs[2],TweenInfo.new(0.25),{C1 = require(script.Parent.Settings).RightPos * CFrame.new(0.1, 0, 0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(-10))}):Play()
			ts(objs[3],TweenInfo.new(0.2),{C1 = require(script.Parent.Settings).LeftPos}):Play()
			wait(0.2)
		...
		if first == false or objs[7].Value < 4  then
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.55,-5.4,-1.15) * CFrame.Angles(math.rad(-100),math.rad(70),math.rad(-41))}):Play()
			wait(0.1)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagPouch"):Play()
			wait(0.25)
			...
			wait(0.3)
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("ShellInsert"):Play()
			ts(objs[2],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.In),{C1 = CFrame.new(-0.975, -0.365, -1.2) * CFrame.Angles(math.rad(-110), math.rad(-2), math.rad(9))}):Play()
			ts(objs[3],TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut),{C1 = CFrame.new(1.6,-0.3,-1.1) * CFrame.Angles(math.rad(-100),math.rad(70),math.rad(-41))}):Play()
			objs[6].Value = objs[6].Value - 1
			objs[7].Value = objs[7].Value + 1
			if objs[7].Value >= 4 then
				first = true
			end
			wait(0.3)
		end
		...
		ReloadAnim = function(char, speed, objs)
			...
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.195,1.4,-0.5) * CFrame.Angles(math.rad(0),math.rad(25),math.rad(0))}):Play()
			wait(0.3)	
			ts(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-0.875, 0, -1.35) * CFrame.Angles(math.rad(-100), math.rad(-2), math.rad(7.5))}):Play()
			wait(0.15)
