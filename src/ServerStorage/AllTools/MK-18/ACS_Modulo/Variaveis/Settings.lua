...
---------------------=[ GERAL ]=--------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	 Name = "Mk-18 .338 LM marksman rifle + REAP-IR"
	,BulletType = ".338 Lapua Magnum AP"
	,Ammo = Var.Ammo.Value
	,ChangeFOV = {50, 30}
	,ZoomAnim = true
	,FocusOnSight = false
...
----------------------------------------------------------------------------------------------------
	...
	,HRecoil = {4,9}				--- Horizontal Recoil
	,AimRecover = 0.5				---- Between 0 & 1
	...
	,HPunchBase = 0.8				--- Horizontal Punch
	...
	,TorsoDamage = {89,115}
	,HeadDamage = {280,305}
	,BulletPenetration = 89			 ---- Between 0 & 100%
	,FallOfDamage = 1
	----------------------------------------------------------------------------------------------------
	-------------------=[ PROJETIL ]=-------------------------------------------------------------------
	----------------------------------------------------------------------------------------------------
