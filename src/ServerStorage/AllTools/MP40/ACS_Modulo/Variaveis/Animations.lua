...
--//Client Animations
	...
	ReloadAnim = function(char, speed, objs)
		...
		if objs[7].Value <= 0 then
			...
			ts(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(-0.875, 0, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
			ts(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(-0.5,0.475,-1.6) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()
			wait(0.3)	
			ts(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(-0.875, 0, -1.35) * CFrame.Angles(math.rad(-100), math.rad(-2), math.rad(7.5))}):Play()
			ts(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(-0.53,0.8,-2.5) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()
			objs[5].Mag.Transparency = 1
			...
			ts(MagCW,TweenInfo.new(0),{C0 = CFrame.new(-0.2, 0.5, -0.75) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(0))}):Play()
			wait(0.3)
			ts(objs[2],TweenInfo.new(0.4),{C1 = CFrame.new(-0.875, 0, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(16.5))}):Play()						
			ts(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(1.195,1.4,-1) * CFrame.Angles(math.rad(0),math.rad(25),math.rad(0))}):Play()
			wait(0.4)			
			ts(objs[2],TweenInfo.new(0.8),{C1 = CFrame.new(-0.875, 0, -1.15) * CFrame.Angles(math.rad(-99), math.rad(-2), math.rad(16.5))}):Play()
			wait(0.4)	
			ts(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(-0.875, 0, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
			ts(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(-0.53,0.8,-2.5) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()
			wait(0.4)
			ts(objs[2],TweenInfo.new(1),{C1 = CFrame.new(-0.875, 0, -1.2) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
			ts(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(-0.5,0.475,-1.6) * CFrame.Angles(math.rad(-100),math.rad(0),math.rad(7.5))}):Play()
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("MagIn"):Play()
			MagC:Destroy()
			objs[5].Mag.Transparency = 0	
			wait(0.5)
			ts(objs[2],TweenInfo.new(0.4),{C1 = CFrame.new(-0.875, 0, -1.25) * CFrame.Angles(math.rad(-103), math.rad(-2), math.rad(7.5))}):Play()
			ts(objs[3],TweenInfo.new(0.25),{C1 = CFrame.new(-0.5,0.475,-1.6) * CFrame.Angles(math.rad(-110),math.rad(0),math.rad(7.5))}):Play()
			if (objs[6].Value - (objs[8].Ammo - objs[7].Value)) < 0 then
				objs[7].Value = objs[7].Value + objs[6].Value
				objs[6].Value = 0
				--Evt.Recarregar:FireServer(objs[5].Value)
