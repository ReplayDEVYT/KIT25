...
---------------------=[ GERAL ]=--------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	 Name = "CMMG MK-47 'Mutant'"
	,BulletType = "7.62x39mm BP"
	,Ammo = Var.Ammo.Value
	,ChangeFOV = {55, 55}
	,ZoomAnim = false
	,FocusOnSight = false
...
-----------------=[ RECOIL & PRECISAO ]=------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	,VRecoil = {1.75,3}				--- Vertical Recoil
	,HRecoil = {1.75,3}				--- Horizontal Recoil
	,AimRecover = .4				---- Between 0 & 1
	,rMain = 0.2					--dont even change this
	,hStep = {-.9,.9}				--horizontalStep, horizontal spread of the weapon
	,tStep = 0.3					--timeStep, might not wanna change this
	,vStep = {3.75,4.5}					--verticalStep, ok you probably shouldnt change any of these
	,RecoilPunch = .175
	,VPunchBase = 0.5				--- Vertical Punch
	,HPunchBase = 0.75				--- Horizontal Punch
	...
	,TorsoDamage = {50,58}
	,HeadDamage = {130,140}
	,BulletPenetration = 63			 ---- Between 0 & 100%
	,FallOfDamage = .9
	----------------------------------------------------------------------------------------------------
	-------------------=[ PROJETIL ]=-------------------------------------------------------------------
	----------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------
	...
	,SlideExtend = Vector3.new(0, 0, 0.275)	
----------------------------------------------------------------------------------------------------
--------------------=[ CFRAME ]=--------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	,EnableHolster = false
