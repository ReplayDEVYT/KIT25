...
--//Client Animations
		...
		ChamberAnim = function(char, speed, objs)
			...
			ts(objs[3],TweenInfo.new(0.35),{C1 = CFrame.new(0.25,0.15,-1.35) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
			wait(0.35)	
			objs[5].Bolt:WaitForChild("SlidePull"):Play()
			ts(objs[3],TweenInfo.new(0.25),{C1 = CFrame.new(0.15,-0.1,-1.15) * CFrame.Angles(math.rad(-120),math.rad(15),math.rad(15))}):Play()
