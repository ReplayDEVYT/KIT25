...
--//Client Animations
	...
	ChamberAnim = function(char, speed, objs)
		if script.Parent.Ammo.Value > 0 and script.Parent.Ammo.Value < 8 then
		ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.2,0.55,-1.35) * CFrame.Angles(math.rad(-90),math.rad(35),math.rad(-25))}):Play()
			...
			wait(0.25)
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("BoltBack"):Play()
		...
		wait(0.15)
		script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("BoltForwards"):Play()
...
wait(0.35)
	...
	ShellInsertAnim = function(char, speed, objs)
		if first then
			...
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.2,0.55,-1.35) * CFrame.Angles(math.rad(-90),math.rad(35),math.rad(-25))}):Play()
			ts(objs[2],TweenInfo.new(0.15),{C1 = CFrame.new(-1.03, .3, -0.73) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(0))}):Play()
			ts(objs[4],TweenInfo.new(0.15),{C1 = CFrame.new(0.53,0.12,.5) * CFrame.Angles(math.rad(105),math.rad(-1),math.rad(2.5))}):Play()
			wait(0.2)
			ts(objs[2],TweenInfo.new(0.25),{C1 = CFrame.new(-1.03, .3, -1) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(0))}):Play()
			ts(objs[4],TweenInfo.new(0.25),{C1 = CFrame.new(0.53,0.05,.5) * CFrame.Angles(math.rad(100),math.rad(-0.5),math.rad(1.75))}):Play()
			wait(0.25)
		...
		if (objs[7].Value == 7 or objs[7].Value == 8) and first == false then
			if objs[7].Value == 7 then
			script.Parent.Parent.Parent.Parent:FindFirstChild('S'..objs[5].Name).Grip:WaitForChild("ShellInsert"):Play()
			ts(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.2,0.55,-1.35) * CFrame.Angles(math.rad(-90),math.rad(35),math.rad(-25))}):Play()
			ts(objs[2],TweenInfo.new(0.15),{C1 = CFrame.new(-1.03, .3, -0.73) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(0))}):Play()
			ts(objs[4],TweenInfo.new(0.15),{C1 = CFrame.new(0.53,0.12,.5) * CFrame.Angles(math.rad(105),math.rad(-1),math.rad(2.5))}):Play()
