...
----------------------------------------------------------------------------------------------------
	 Name = "KS-23M"
	,BulletType = "23x75mm Shrapnel 10"
	,Ammo = Var.Ammo.Value
	,ChangeFOV = {55, 55}
	,ZoomAnim = false
	,FocusOnSight = false
...
-----------------=[ RECOIL & PRECISAO ]=------------------------------------------------------------
----------------------------------------------------------------------------------------------------
	,VRecoil = {17,26}				--- Vertical Recoil
	,HRecoil = {5,10}				--- Horizontal Recoil
...
----------------------------------------------------------------------------------------------------
	...
	,TorsoDamage = {35,54}
	,HeadDamage = {130,301}
	,BulletPenetration = 20 ---- Between 0 & 100%
	,FallOfDamage = 0.7
----------------------------------------------------------------------------------------------------
-------------------=[ PROJETIL ]=-------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------
	...
	,HolsterPos = CFrame.new(0,0,0.65) * CFrame.Angles(math.rad(-90),math.rad(35),math.rad(90))
