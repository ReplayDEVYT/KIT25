...
function onTouched(hit)
	if hit.Parent:FindFirstChild("Humanoid") and not bounced and (hit.Parent:FindFirstChild("Top") and hit.Parent.Top:FindFirstChild("Mount") or model:FindFirstChild("NoHelm")) then
		bounced = true
		delay(2,function()
			bounced = false
		end)
		...
		char:FindFirstChild("nods").NVEnabled = true
		char:FindFirstChild("Overlay").Value = downnvg.NVG_Settings.OverlayImage.Value
	end
end
